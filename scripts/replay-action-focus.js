...
const syntheticCases = [
  ...
  {
    name: 'semantic continuity preserves a question without an explicit reformulation marker',
    action: 'WHAT_TO_SAY',
    selectedSegments: [
      {
        role: 'interviewer',
        speaker: 'speaker_4',
        canonicalRole: 'speaker_4',
        timestamp: Date.now() - 54_000,
        text: "Comment allez-vous garantir la cohérence des stocks entre les pharmacies ?",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
      {
    ...
    expectKind: 'direct_question',
    targetMustInclude: ['cohérence des stocks', 'pharmacies'],
    contextMustInclude: ['hors ligne', 'stock négatif'],
  },
  {
    name: 'one shared production keyword does not preserve a stale deployment question',
    action: 'WHAT_TO_SAY',
    selectedSegments: [
      {
        role: 'interviewer',
        speaker: 'speaker_5',
        canonicalRole: 'speaker_5',
        timestamp: Date.now() - 55_000,
        text: "Comment avez-vous sécurisé le déploiement en production ?",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
      {
        role: 'interviewer',
        ...
        text: "Notre équipe prépare la production vidéo de la prochaine campagne marketing avec un studio externe et plusieurs formats pour les réseaux sociaux.",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
      {
        role: 'interviewer',
        ...
        canonicalRole: 'speaker_5',
        timestamp: Date.now() - 5_000,
        text: "La production vidéo et la campagne marketing doivent respecter le nouveau calendrier éditorial, les validations de marque et le budget média déjà approuvé.",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
    ],
    expectKind: 'topic',
    targetMustInclude: ['production vidéo', 'campagne marketing'],
    mustNotInclude: ['déploiement'],
  },
  {
    name: 'one shared client keyword does not preserve a stale customer-retention question',
    action: 'WHAT_TO_SAY',
    selectedSegments: [
      {
        role: 'interviewer',
        speaker: 'speaker_6',
        canonicalRole: 'speaker_6',
        timestamp: Date.now() - 56_000,
        text: "Comment fidélisez-vous vos clients après leur premier achat ?",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
      {
        role: 'interviewer',
        ...
        canonicalRole: 'speaker_6',
        timestamp: Date.now() - 30_000,
        text: "Le client desktop doit recevoir les mises à jour automatiques sans interrompre les sessions de travail ni perdre les préférences locales.",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
      {
        role: 'interviewer',
        ...
        text: "Le client desktop et les mises à jour automatiques passent désormais par un canal progressif avec reprise après échec et vérification de signature.",
        qualityFlags: ['system_audio', 'speaker_stable', 'trusted_interlocutor'],
      },
    ],
    expectKind: 'topic',
