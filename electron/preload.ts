...
contextBridge.exposeInMainWorld("electronAPI", {
  ...
  setDeepInfraApiKey: (apiKey: string) => ipcRenderer.invoke("set-deepinfra-api-key", apiKey),
  setOpenCodeGoApiKey: (apiKey: string) => ipcRenderer.invoke("set-opencode-go-api-key", apiKey),
  ...
  onPreAnswerReady: (callback: (data: { available: boolean; question?: string }) => void) => {
    const subscription = (_: any, data: any) => callback(data)
  ...
  // Streaming Chat
  streamGeminiChat: (message: string, imagePaths?: string[], context?: string, options?: { skipSystemPrompt?: boolean, ignoreKnowledgeMode?: boolean, skipTranscript?: boolean }) => ipcRenderer.invoke("gemini-chat-stream", message, imagePaths, context, options),
  cancelGeminiStream: () => ipcRenderer.invoke("cancel-gemini-chat-stream"),
