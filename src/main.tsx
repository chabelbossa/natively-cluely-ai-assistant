...
if (!window.electronAPI) {
  ...
  (window as any).electronAPI = new Proxy({
    ...
    getStoredCredentials: async () => ({
      ...
      localSttGlossary: 'Kyntia, SSO, Next.js, NestJS, WaChap, Kloo, Artiweb, API, frontend, backend',
      localSttWhisperCppModelPath: '/Users/user/Library/Application Support/com.prakashjoshipax.VoiceInk/WhisperModels/ggml-large-v3-turbo-q5_0.bin',
